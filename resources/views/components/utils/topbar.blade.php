...
{{--            </li>--}}
            <li>
                <a class="nav-link waves-effect waves-light nav-user" href="{{url('app/account')}}"
                >
                    <img src="{{asset('images/user.png')}}" alt="profile-user" class="rounded-circle thumb-xs"/>
                    <span
                        class="ms-1 nav-user-name hidden-sm">{{\Str::ucfirst(user()->first_name) ." ".\Str::ucfirst(user()->last_name)}}</span>
                </a>
            </li>
            ...
            {{--                   aria-haspopup="false" aria-expanded="false">--}}
            {{--                    <img src="{{asset('images/user.png')}}" alt="account-user" class="rounded-circle thumb-xs" />--}}

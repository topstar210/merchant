<div class="form-group mb-3">
    ...
    <div class="input-group phone">
        <div wire:ignore>
        <select class="phone_code form-control mb-3 @error($key."_code") is-invalid @enderror custom-select"
                id="{{$key}}_code"
                name="{{$key}}_code"  @if(isset($disabled)) disabled @endif  @if(isset($js)) wire:model="{{$key}}_code" @endif style="width: 100px;" required>
            {{$slot}}
        </select>
        </div>
